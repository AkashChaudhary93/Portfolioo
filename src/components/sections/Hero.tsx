...
const Hero = () => {
  return (
    <section className="bg-mustard relative w-full min-h-screen flex items-center pt-28 pb-28 px-6 md:px-12 border-b-4 border-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl font-medium text-text-dark-gray max-w-xl leading-relaxed font-sans border-l-4 border-black pl-5">
        ...
        <div className="relative">
          <div className="bg-navy border-4 border-black rounded-lg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden text-white relative z-10 mx-auto w-full max-w-lg transform lg:rotate-1 hover:rotate-0 transition-transform">
...
function InfoPill({ icon, label, value }: { icon: React.ReactNode; label: string; value: string }) {
  return (
    <div className="bg-white border-4 border-black p-4 rounded-md shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover-lift">
