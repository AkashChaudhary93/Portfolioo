...
const Projects = () => {
  return (
    <section id="work" className="bg-navy py-28 px-6 md:px-12 border-b-4 border-black text-white relative">
          ...
          {projects.map((project, i) => (
            <div key={i} className="bg-cream text-black border-4 border-black rounded-md shadow-[8px_8px_0px_0px_rgba(245,197,24,1)] flex flex-col h-full  ">
              ...
              <div className="p-6 md:p-8 flex-grow flex flex-col bg-white rounded-b-sm">
                <h3 className="text-2xl md:text-3xl font-black mb-3 uppercase leading-tight">{project.title}</h3>
                ...
                <div className="flex gap-4 mt-auto">
                  <a href={project.source || '#'} target="_blank" rel="noreferrer" className="flex-1 text-center font-black uppercase border-4 border-black py-3 hover:bg-mustard transition-transform flex items-center justify-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-md hover-lift">
                    <FiGithub /> Code
                  </a>
                  <a href="#" className="flex-1 text-center font-black uppercase border-4 border-black py-3 bg-black text-white hover:bg-sky-blue hover:text-black transition-transform flex items-center justify-center gap-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-md hover-lift">
                    <FiExternalLink /> Live
                  </a>
                </div>
              </div>
